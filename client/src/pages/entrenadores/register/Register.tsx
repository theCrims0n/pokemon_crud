...
export const Register = () => {
    ...
    const { postEntrenador } = useEntrenadores()
            ...
            <>
                {
                    isSubmitting ?
                        ...
                        :
                        <button type='submit' className="block w-full btn-success">{'Guardar'}</button>
                }
            </>
        )
    }
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className='grid gap-6 mb-6 md:grid-cols-2 '>
                        <div>
                            ...
                            <input maxLength={50} type="text" {...register('nombre', { required: 'El campo es requerido' })}
                        ...
                        <div>
                            ...
                            <input maxLength={50} type="text" {...register('apellidos', { required: 'El campo es requerido' })}
                                className="px-5 py-2 border text-sm rounded-lg block w-full p-2.5 bg-gray-200 rounded mb-5" />
                        ...
                        <div>
                            ...
                            <input maxLength={50} type="text" {...register('numeroTel', { required: 'El campo es requerido' })}
                                className="px-5 py-2 border text-sm rounded-lg block w-full p-2.5 bg-gray-200 rounded mb-5" />
                        ...
                        <div>
                            ...
                            <input maxLength={50} type="number" {...register('medallas', { required: false })}
                                className="px-5 py-2 border text-sm rounded-lg block w-full p-2.5 bg-gray-200 rounded mb-5" />
                        </div>
